...
def scd2_simple(input_filepath, updates_filepath, output_directory, future_end_datetime):
    start_time = time.time()
...
def scd2_complex(input_filepath, updates_filepath, output_directory, future_end_datetime):
    start_time = time.time()
